...
#include "Abstract\Init.h"
#include "Abstract\FunctionalClass.h"
#include "Abstract\Perform.h"
#include "Abstract\CleanUp.h"
#include "Abstract\Utils\Tuple.h"
#include "Abstract\Utils\NUtils.h"
#include <vector>
#include <Windows.h>

class CTemplateMethodBoolHelp2
{
private:
	void* _inDataBus;
...
public:
	...
	CTemplateMethodBoolHelp2(CInit *pInit,
		CPerform *pPerform,
		CCleanUp* pCleanUp,
		...
		vector<char>* inFilterChain)
	{
		...
		pCharDataBus->push_back(inMainChainCopy);			  //8
